...
<head>
    ...
    <title>Presensi Peserta Bimbingan - Mentor</title>
...
<body class="bg-gray-100 font-sans">
    <nav class="bg-purple-600 p-4 text-white flex justify-between items-center shadow-md">
        <div class="flex items-center">
            ...
            <h1 class="text-2xl font-bold">Presensi Peserta Bimbingan</h1>
        </div>
        <div class="flex items-center">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white p-8 rounded-lg shadow-md mb-6">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">Data Presensi Peserta Magang Bimbingan Anda
            </h2>
            ...
            <div class="mb-6 flex justify-center items-center">
                ...
                <input type="date" id="attendance_date" name="attendance_date" class="form-input"
                    value="{{ $selectedDate }}"
                    onchange="window.location.href = '{{ route('mentor.attendance') }}?date=' + this.value;">
            </div>
            ...
            @if ($interns->isEmpty())
                <p class="text-center text-gray-600">Tidak ada peserta magang bimbingan Anda yang ditemukan atau data
                    presensi untuk tanggal ini.</p>
            @else
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($interns as $intern)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <a href="{{ route('mentor.attendance.show', $intern->intern_id) }}"
