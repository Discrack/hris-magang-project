...
<head>
    ...
    <title>Manajemen Penggajian - Admin</title>
...
<body class="bg-gray-100 font-sans">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mb-6">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">Daftar Catatan Penggajian</h2>
            ...
            <div class="flex justify-end mb-4">
                <a href="{{ route('admin.payroll.create') }}"
                    ...
                    Tambah Catatan Gaji Baru
                </a>
            </div>

            @if ($payrolls->isEmpty())
                <p class="text-center text-gray-600">Belum ada catatan penggajian.</p>
            @else
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center space-x-2">
                                            <a href="{{ route('admin.payroll.edit', $payroll->payroll_id) }}"
                                                class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded-lg text-xs transition duration-300">
                                                Edit
                                            </a>
                                            <form action="{{ route('admin.payroll.destroy', $payroll->payroll_id) }}"
                                                method="POST"
                                                onsubmit="return confirm('Apakah Anda yakin ingin menghapus catatan gaji ini?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
