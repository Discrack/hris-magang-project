...
<head>
    ...
    <title>Manajemen Informasi Program - Admin</title>
...
<body class="bg-gray-100 font-sans">
    <nav class="bg-blue-600 p-4 text-white flex justify-between items-center shadow-md">
        <div class="flex items-center">
            ...
            <h1 class="text-2xl font-bold">Manajemen Informasi Program</h1>
        </div>
        <div class="flex items-center">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mb-6">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">Daftar Informasi Program</h2>

            <div class="flex justify-end mb-4">
                <a href="{{ route('admin.program_info.create') }}"
            ...
            @if ($programInfos->isEmpty())
                <p class="text-center text-gray-600">Belum ada informasi program yang ditambahkan.</p>
            @else
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($programInfos as $info)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">{{ $info->title }}</td>
                                    <td class="py-3 px-6 text-left">{{ Str::limit($info->content, 70) }}</td>
