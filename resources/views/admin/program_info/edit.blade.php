...
<head>
    ...
    <title>Edit Informasi Program - Admin</title>
...
<body class="bg-gray-100 font-sans">
    <nav class="bg-blue-600 p-4 text-white flex justify-between items-center shadow-md">
        <div class="flex items-center">
            ...
            <h1 class="text-2xl font-bold">Edit Informasi Program</h1>
        </div>
        <div class="flex items-center">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">Form Edit Informasi Program</h2>

            <form action="{{ route('admin.program_info.update', $programInfo->info_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title"
                        ...
                        value="{{ old('title', $programInfo->title) }}" required>
                    @error('title')
                ...
                <div class="mb-6">
                    ...
                    <textarea id="content" name="content" rows="6"
                        class="shadow-sm appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>{{ old('content', $programInfo->content) }}</textarea>
                    @error('content')
                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                    @enderror
                </div>
