...
<head>
    ...
    <title>Penilaian & Feedback Saya - Peserta Magang</title>
...
<body class="bg-gray-100 font-sans">
    <nav class="bg-blue-600 p-4 text-white flex justify-between items-center shadow-md">
        <div class="flex items-center">
            ...
            <h1 class="text-2xl font-bold">Penilaian & Feedback Saya</h1>
        </div>
        <div class="flex items-center">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">Riwayat Penilaian & Feedback Anda</h2>

            @if ($assessments->isEmpty())
                <p class="text-center text-gray-600">Belum ada penilaian atau feedback untuk Anda.</p>
            @else
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($assessments as $assessment)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-left">{{ $assessment->feedback ?? '-' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
